            ...
            <div className="grid w-full grid-cols-8 gap-16">
                ...
                <div className="col-span-2 flex flex-col items-end justify-center gap-16 dark:text-white">
                    <div className="flex flex-col items-end justify-center">
                        ...
                        <h2 className="text-xl font-medium capitalize text-dark/75 dark:text-white/75">Satisfied Clients</h2>
                    </div>
                    <div className="flex flex-col items-end justify-center">
                        <span className="inline-block text-7xl font-bold"><AnimatedNumbers value={300} />+</span>
                        <h2 className="text-xl font-medium capitalize text-dark/75 dark:text-white/75">Projects Completed</h2>
                    </div>
                    <div className="flex flex-col items-end justify-center">
                        <span className="inline-block text-7xl font-bold"><AnimatedNumbers value={7} />+</span>
                        <h2 className="text-xl font-medium capitalize text-dark/75 dark:text-white/75">Years Of Experience</h2>
                    </div>
                </div>
            </div>
        </>

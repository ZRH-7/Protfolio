	...
	theme: {
		extend: {
			...
			backgroundImage: {
				...
				circularDark: 'repeating-radial-gradient(hsla(0,0%,100%,.5) 2px,#1b1b1b 8px,#1b1b1b 100px);',
				circularLightLg: 'repeating-radial-gradient(rgba(0,0,0,.4) 2px, #f5f5f5 5px, #f5f5f5 80px);',
				circularDarkLg: 'repeating-radial-gradient(hsla(0,0%,100%,.5) 2px,#1b1b1b 8px,#1b1b1b 80px);', circularLightMd: "repeating-radial-gradient(rgba(0,0,0,0.4) 2px,#f5f5f5 5px,#f5f5f5 60px)",
